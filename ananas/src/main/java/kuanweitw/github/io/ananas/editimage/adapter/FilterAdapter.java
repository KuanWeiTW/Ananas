...
public class FilterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FilterAdapter(FilterListFragment fragment, Context context) {
        ...
        filters = filterListFragment.getResources().getStringArray(R.array.kuanweitw_github_io_ananas_filters);
        filterImages = filterListFragment.getResources().getStringArray(R.array.kuanweitw_github_io_ananas_filter_drawable_list);
    }
